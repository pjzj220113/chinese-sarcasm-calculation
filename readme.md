...
Acc = ![img](images/clip_image002.gif)。其中m为样本数量，![img](images/clip_image004.gif) 为真实标签，f(![img](images/clip_image006.gif))为预测标签，![img](images/clip_image008.gif)(·)为指示函数，在·为真和假时分别取值1、0，S为求和符号；

Dice = ![img](images/clip_image010.gif) 。其中m为样本数量，![img](images/clip_image004.gif) 为真实标签集合，f(![img](images/clip_image006.gif))为预测标签集合，S为求和符号。
